...
# 📖 hellor-reails-app-v2 <a name="about-project"></a>

# hellor-reails-app-v2
This is project to test my knowledge in RoR and React / Redux
...
```
git clone https://github.com/NelsonAraujo93/hellor-reails-app-v2.git
```
...
Feel free to check the [issues page](https://github.com/NelsonAraujo93/hellor-reails-app-v2/issues).
